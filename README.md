# @swenkerorg/doloremque-praesentium-incidunt

[![Build Status](https://secure.travis-ci.org/nathanboktae/@swenkerorg/doloremque-praesentium-incidunt.png)](http://travis-ci.org/nathanboktae/@swenkerorg/doloremque-praesentium-incidunt)

@swenkerorg/doloremque-praesentium-incidunt is an extension to the [chai](http://chaijs.com/) assertion library that
...
```
npm install @swenkerorg/doloremque-praesentium-incidunt
```

### bower

```
bower install @swenkerorg/doloremque-praesentium-incidunt
```
...
chai.use(require('@swenkerorg/doloremque-praesentium-incidunt'))
```

### AMD

```javascript
require(['chai', '@swenkerorg/doloremque-praesentium-incidunt'], function(chai, chaiDom) {
  chai.use(chaiDom)
})
```
...
<script src="@swenkerorg/doloremque-praesentium-incidunt.js"></script>
```
